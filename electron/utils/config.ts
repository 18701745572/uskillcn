 ...
 */
export const PORTS = {
  /** uskillcn GUI development server port */
  uskillcn_DEV: 5173,
  
  /** uskillcn GUI production port (for reference) */
  uskillcn_GUI: 23333,

  /** Local host API server port */
  uskillcn_HOST_API: 3210,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `uskillcn_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  /** uskillcn configuration directory */
  uskillcn_CONFIG: '~/.uskillcn',
