...
/**
 * Get uskillcn config directory
 */
export function getuskillcnConfigDir(): string {
  return join(homedir(), '.uskillcn');
}

/**
 * Get uskillcn logs directory
 */
