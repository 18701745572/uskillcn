 ...
 * "openrouter.ai" carries the uskillcn app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__uskillcnFetchPatched) return;
  globalThis.__uskillcnFetchPatched = true;

  globalThis.fetch = function uskillcnFetch(input, init) {
    var url =
    ...
    if (url.indexOf('openrouter.ai') !== -1) {
      ...
      delete flat['x-title'];
      delete flat['X-Title'];
      flat['HTTP-Referer'] = 'https://uskill.cn';
      flat['X-Title'] = 'uskillcn';
      init.headers = flat;
    }
