...
<p align="center">
  <img src="src/assets/logo.svg" width="128" height="128" alt="uskillcn Logo" />
</p>

<h1 align="center">uskillcn</h1>
...
<p align="center">
  ...
  <a href="#why-uskillcn">Why uskillcn</a> •
...
<p align="center">
  ...
  <img src="https://img.shields.io/github/downloads/ValueCell-ai/uskillcn/total?color=%23027DEB" alt="Downloads" />
...
**uskillcn** bridges the gap between powerful AI agents and everyday users. Built on top of [OpenClaw](https://github.com/OpenClaw), it transforms command-line AI orchestration into an accessible, beautiful desktop experience—no terminal required.

Whether you're automating workflows, managing AI-powered channels, or scheduling intelligent tasks, uskillcn provides the interface you need to harness AI agents effectively.

uskillcn comes pre-configured with best-practice model providers and natively supports Windows as well as multi-language settings. Of course, you can also fine-tune advanced configurations via **Settings → Advanced → Developer Mode**.
...
Building AI agents shouldn't require mastering the command line. uskillcn was designed with a simple philosophy: **powerful technology deserves an interface that respects your time.**

| Challenge | uskillcn Solution |
|-----------|----------------|
...
uskillcn is built directly upon the official **OpenClaw** core. Instead of requiring a separate installation, we embed the runtime within the application to provide a seamless "battery-included" experience.
...
### 🌙 Adaptive Theming
Light mode, dark mode, or system-synchronized themes. uskillcn adapts to your preferences automatically.
...
Download the latest release for your platform from the [Releases](https://github.com/18701745572/uskillcn/releases) page.

#### Build from Source

```bash
# Clone the repository
git clone https://github.com/18701745572/uskillcn.git
cd uskillcn
...
When you launch uskillcn for the first time, the **Setup Wizard** will guide you through:
...
> Note for Moonshot (Kimi): uskillcn keeps Kimi web search enabled by default.  
> When Moonshot is configured, uskillcn also syncs Kimi web search to the China endpoint (`https://api.moonshot.cn/v1`) in OpenClaw config.

### Proxy Settings

uskillcn includes built-in proxy settings for environments where Electron, the OpenClaw Gateway, or channels such as Telegram need to reach the internet through a local proxy client.
...
- If advanced proxy fields are left empty, uskillcn falls back to `Proxy Server`.
- Saving proxy settings reapplies Electron networking immediately and restarts the Gateway automatically.
- uskillcn also syncs the proxy to OpenClaw's Telegram channel config when Telegram is enabled.

---

## Architecture

uskillcn employs a **dual-process architecture** with a unified host API layer. The renderer talks to a single client abstraction, while Electron Main owns protocol selection and process lifecycle:

```┌─────────────────────────────────────────────────────────────────┐
│                        uskillcn Desktop App                         │
│                                                                  │
│  ┌────────────────────────────────────────────────────────────┐  │
...
We welcome contributions from the community! Whether it's bug fixes, new features, documentation improvements, or translations—every contribution helps make uskillcn better.
...
uskillcn is built on the shoulders of excellent open-source projects:
...
### uskillcn Partner Program 🚀

We're launching the uskillcn Partner Program and looking for partners who can help introduce uskillcn to more clients, especially those with custom AI agent or automation needs.

Partners help connect us with potential users and projects, while the uskillcn team provides full technical support, customization, and integration.
...
<p align="center">
  <img src="https://api.star-history.com/svg?repos=ValueCell-ai/uskillcn&type=Date" alt="Star History Chart" />
</p>
...
uskillcn is released under the [MIT License](LICENSE). You're free to use, modify, and distribute this software.
